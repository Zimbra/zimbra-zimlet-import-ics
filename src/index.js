...
export default function Zimlet(context) {
	...
	exports.init = function init() {
		...
		plugins.register('slot::calendar-context-add-holiday', provide(context)(createMore));
		plugins.register('slot::attachment-single-action', provide(context)(createMore));
	};
	return exports;
}
